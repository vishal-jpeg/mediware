                        ...
                        <tbody>
                          @foreach ($scheme as $schemes)
                              <tr>
                                ...
                                <td><a class="btn btn-primary" href="{{url('del_scheme',$schemes->id)}}" onclick="return confirm('Are you sure that you want to delete this scheme')" type="button"> Delete </a></td>
                              </td>
                              </tr>
                          @endforeach
                        </tbody>
